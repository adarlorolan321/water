        ...
        <div class="bg-white rounded-lg p-3 overflow-x-auto">
            <table class="table-auto w-full">
                ...
                {{$order->isPaid() ? 'bg-emerald-500' : 'bg-gray-400' }}">
                        ...
                        <td class="py-1 px-2 gap-2 w-[100px]">
                        @if ($order->status === 'completed')
                            <button class=" items-center py-1 btn-primary whitespace-nowrap">
                                <!-- Add your feedback comment or link to the feedback form here -->
                                <!-- For example: -->
                                <a href="{{ route('feedbacks.create', ['order_id' => $order->id]) }}">Leave Feedback</a>
                            </button>
                            @endif
                        </td>
                    </tr>
